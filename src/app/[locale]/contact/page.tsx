  ...
  return (
    <div className="pt-28 sm:pt-36 pb-20 bg-[#F7F8F5] min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <RevealGroup staggerDelay={0.06} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
          {/* Card 1: Call */}
          <RevealItem className="h-full">
            <a
              href={`tel:${settings.phone}`}
              className="p-5 rounded-2xl bg-white border border-[#DCE4E0] hover:border-[#074031]/40 hover:shadow-md transition-all flex items-center gap-4 group h-full"
            >
          ...
          <RevealItem className="h-full">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="p-5 rounded-2xl bg-white border border-[#DCE4E0] hover:border-[#FEBE16] hover:shadow-md transition-all flex items-center gap-4 group h-full"
            >
              <div className="w-12 h-12 rounded-full bg-[#074031] text-white flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform shadow-xs">
