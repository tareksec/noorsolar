  ...
  return (
    <div className="pt-28 sm:pt-36 pb-24 bg-[#F7F8F5] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Value Pillars */}
        <RevealGroup staggerDelay={0.08} className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <RevealItem className="h-full">
            <div className="h-full p-8 rounded-3xl bg-white border border-[#DCE4E0] shadow-sm">
        ...
        <RevealGroup staggerDelay={0.08} className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          <RevealItem className="h-full">
            <div className="h-full rounded-[36px] bg-white border border-[#DCE4E0] p-6 sm:p-8 flex flex-col justify-between">
