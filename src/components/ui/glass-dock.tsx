            ...
            >
                ...
                >
                    ...
                    {items.map((el, index) => {
                        ...
                        const isRouteActive = activeIndex === index;
                        const isActive = activeIndex !== undefined ? isRouteActive : isHovered; // Simplified for this demo
                        ...
                        // (only when no custom icon is provided)
                        const type = el.title.toLowerCase();
                        const isAnimated = !el.icon && ['home', 'blog', 'marker', 'email', 'linkedin', 'x', 'github'].includes(type);
                        ...
                        return (
                            ...
                            >
                                ...
                                {isRouteActive && (
                                    <span aria-hidden="true" className="absolute -bottom-0.5 h-1 w-1 rounded-full bg-[#FEBE16]" />
                                )}
                            </div>
                        );
                    })}
