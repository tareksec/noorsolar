...
import { MapPin, Zap, Calendar, Building2, PackageCheck, ArrowRight } from "lucide-react";
        ...
        <Reveal y={20} duration={0.6}>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <div className="shrink-0">
              ...
              >
                <span>{isBn ? "সকল প্রকল্প রেফারেন্স দেখুন" : "View All Project References"}</span>
          ...
          {projects.map((project) => (
            <RevealItem key={project.id} className="h-full">
              <Link
                ...
                className="h-full rounded-[32px] bg-white border border-[#DCE4E0] hover:border-[#074031] overflow-hidden flex flex-col justify-between shadow-xs hover:shadow-xl transition-all duration-300 group cursor-pointer block"
              >
                {/* Image Container */}
                {project.image && (
                ...
                <div className="p-6 sm:p-7 flex-1 flex flex-col justify-between">
                  ...
                  <div className="pt-4 border-t border-[#DCE4E0] flex items-center justify-between text-xs font-mono">
                    {project.productsSupplied ? (
                      <div className="flex items-center gap-1.5 text-[#17251F] truncate max-w-[65%]">
                    ...
                    <div className="flex items-center gap-1 text-[#074031] font-bold shrink-0 group-hover:translate-x-1 transition-transform">
