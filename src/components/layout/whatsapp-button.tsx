...
export function WhatsAppButton({ phone = "8801700000000", locale: propLocale }: WhatsAppButtonProps) {
  ...
  return (
    <a
      ...
      className="fixed bottom-[calc(1rem+env(safe-area-inset-bottom,0px))] right-[calc(1rem+env(safe-area-inset-right,0px))] sm:bottom-6 sm:right-6 z-40 flex items-center justify-center min-w-[48px] min-h-[48px] gap-2 p-3 sm:px-4 sm:py-3 rounded-full bg-[#111311] text-[#CEF23E] border border-[rgba(255,255,255,0.2)] shadow-2xl transition-all duration-300 hover:scale-105 hover:bg-[#1A1D1A] hover:shadow-[0_10px_30px_-5px_rgba(206,242,62,0.3)] active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#CEF23E]"
    >
