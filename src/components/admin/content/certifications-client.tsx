                ...
                <>
                  ...
                  <div className='flex items-center gap-2 shrink-0'>
                    ...
                    <form action={deleteCertificationAction}>
                      <input type='hidden' name='id' value={item.id} />
                      <button type='submit' onClick={(e) => { if (!confirm('Delete this certification?')) e.preventDefault(); }} title='Delete this certification' className='p-1.5 rounded-lg border border-[#DDE1DC] text-red-500 hover:bg-red-50'>
